...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.leCodeCallingPrice.textChanged.connect(self.CodeChangedInCallingPrice)
    ...
    def CodeChangedInCallingPrice(self):
    ...
    def Chart(self):
        ...
        self.vlayChart = QVBoxLayout()

        self.gviewChart.setLayout(self.vlayChart)
        # self.gviewChart.resize(450, 300)
        ...
        # fplt.candlestick_ochl(price['Price'][['Open','Close','High','Low']])
